...
<head>
    ...
    <link rel="manifest" href="/uaskte/public/manifest.json">
    <meta name="theme-color" content="#002398">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=JetBrains+Mono&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="/uaskte/public/assets/css/style.css">
    <link rel="apple-touch-icon" href="/uaskte/public/assets/img/icon-192.png">
